...
var MySQLErrName = map[uint16]string{
	...
	ErrBinlogPurgeFatalErr:                      "Fatalf error during log purge",
	...
	ErrXaerRmerr:                                "XAERRMERR: Fatalf error occurred in the transaction branch - check your data for consistency",
